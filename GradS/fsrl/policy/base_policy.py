...
class BasePolicy(ABC, nn.Module):
    ...
    * :meth:`~srl.policy.BasePolicy.update`: the main interface for training, i.e.,
    ...
    def get_metrics(batch: Batch):
        ...
        sub_cost_0 = batch.info.get("sub_cost_0", np.zeros(batch.rew.shape))
        sub_cost_1 = batch.info.get("sub_cost_1", np.zeros(batch.rew.shape))
        sub_cost_2 = batch.info.get("sub_cost_2", np.zeros(batch.rew.shape))

        sub_cost_3 = batch.info.get("sub_cost_3", np.zeros(batch.rew.shape))
        sub_cost_4 = batch.info.get("sub_cost_4", np.zeros(batch.rew.shape))
        sub_cost_5 = batch.info.get("sub_cost_5", np.zeros(batch.rew.shape))

        sub_cost_6 = batch.info.get("sub_cost_6", np.zeros(batch.rew.shape))
        sub_cost_7 = batch.info.get("sub_cost_7", np.zeros(batch.rew.shape))

        sub_cost_8 = batch.info.get("sub_cost_8", np.zeros(batch.rew.shape))
        sub_cost_9 = batch.info.get("sub_cost_9", np.zeros(batch.rew.shape))
        sub_cost_10 = batch.info.get("sub_cost_10", np.zeros(batch.rew.shape))


        sub_cost_11 = batch.info.get("sub_cost_11", np.zeros(batch.rew.shape))
        sub_cost_12 = batch.info.get("sub_cost_12", np.zeros(batch.rew.shape))

        sub_cost_13 = batch.info.get("sub_cost_13", np.zeros(batch.rew.shape))
        sub_cost_14 = batch.info.get("sub_cost_14", np.zeros(batch.rew.shape))
        sub_cost_15 = batch.info.get("sub_cost_15", np.zeros(batch.rew.shape))

        sub_cost_16 = batch.info.get("sub_cost_16", np.zeros(batch.rew.shape))
        sub_cost_17 = batch.info.get("sub_cost_17", np.zeros(batch.rew.shape))

        sub_cost_18 = batch.info.get("sub_cost_18", np.zeros(batch.rew.shape))
        sub_cost_19 = batch.info.get("sub_cost_19", np.zeros(batch.rew.shape))
        sub_cost_20 = batch.info.get("sub_cost_20", np.zeros(batch.rew.shape))

        metrics = [batch.rew, sub_cost_0, sub_cost_1, sub_cost_2,
                   sub_cost_3, sub_cost_4, sub_cost_5,
                   sub_cost_6, sub_cost_7, sub_cost_8,
                   sub_cost_9, sub_cost_10,

                   sub_cost_11, sub_cost_12,
                   sub_cost_13, sub_cost_14, sub_cost_15,
                   sub_cost_16, sub_cost_17, sub_cost_18,
                   sub_cost_19, sub_cost_20,
                   ]
        return metrics
