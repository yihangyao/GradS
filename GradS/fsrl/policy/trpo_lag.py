...
class TRPOLagrangian(LagrangianPolicy):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            lr_scheduler, vanilla=vanilla, random_con_selection=random_con_selection, gradient_shaping=gradient_shaping, max_singleAC=max_singleAC, optim=optim
        )
        self.optim = optim
    ...
    def policy_loss(self, batch: Batch, dist: Type[torch.distributions.Distribution], require_GS = True):
        ...
        loss_actor_safety, stats_actor = self.safety_loss(values, required_GS=require_GS)
            ...
            for minibatch in batch.split(batch_size, merge_last=True):
                ...
                with torch.no_grad():
                    ...
                    for i in range(self._max_backtracks):
                        ...
                        loss_actor_new, _ = self.policy_loss(minibatch, new_dist, require_GS=False)
