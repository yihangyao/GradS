...
class TrainCfg:
    # general task params
    task: str = "SafetyCarCircle-v0" # "SafetyPointGoal1Gymnasium-v0"
    ...
    cost_limit: Tuple[float, ...] = (50, 50, 50, 50, 40, 40) # No longer used
    device: str = "cpu"
    ...
    lagrangian_pid: Tuple[float, ...] = (0.1, 0.001, 0.1) # (0.05, 0.0005, 0.1) (0.25, 0.0025, 0.5)
    rescaling: bool = True
