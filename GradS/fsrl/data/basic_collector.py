...
class BasicCollector:
    ...
    def collect(
        ...
        """
        Modified for multi-constraint settings (sub_cost_0, sub_cost_1)
        ...
        while True:
            ...
            sub_cost_0 = info.get("sub_cost_0", 0)
            sub_cost_1 = info.get("sub_cost_1", 0)
            sub_cost_2 = info.get("sub_cost_2", 0)
            sub_cost_3 = info.get("sub_cost_3", 0)
            sub_cost_4 = info.get("sub_cost_4", 0)
            sub_cost_5 = info.get("sub_cost_5", 0)
            sub_cost_6 = info.get("sub_cost_6", 0)
            sub_cost_7 = info.get("sub_cost_7", 0)
            sub_cost_8 = info.get("sub_cost_8", 0)
            sub_cost_9 = info.get("sub_cost_9", 0)
            sub_cost_10 = info.get("sub_cost_10", 0)
            # sub_cost_8 = info.get("sub_cost_5", 0)

            m_cost = info.get("m_cost", 0)
            ...
            self.data.update(
                ...
                cost=[cost],
                sub_cost_0 = [sub_cost_0],
                sub_cost_1 = [sub_cost_1],
                sub_cost_2 = [sub_cost_2],
                sub_cost_3 = [sub_cost_3],
                sub_cost_4 = [sub_cost_4],
                sub_cost_5 = [sub_cost_5],
                sub_cost_6 = [sub_cost_6],
                sub_cost_7 = [sub_cost_7],
                sub_cost_8 = [sub_cost_8],
                sub_cost_9 = [sub_cost_9],
                sub_cost_10 = [sub_cost_10],
                m_cost = m_cost,
                info=[info]
            )
            ...
            total_cost += cost
            total_sub_cost_0 += sub_cost_0
            total_sub_cost_1 += sub_cost_1
            total_sub_cost_2 += sub_cost_2
            total_sub_cost_3 += sub_cost_3
            total_sub_cost_4 += sub_cost_4
            total_sub_cost_5 += sub_cost_5
            total_sub_cost_6 += sub_cost_6
            total_sub_cost_7 += sub_cost_7
            total_sub_cost_8 += sub_cost_8
            total_sub_cost_9 += sub_cost_9
            total_sub_cost_10 += sub_cost_10
            ...
            if self.traj_buffer is not None:
                traj_data = Batch(
                    ...
                    sub_cost_0=self.data.sub_cost_0,
                    sub_cost_1=self.data.sub_cost_1,
                    sub_cost_2=self.data.sub_cost_2,
                    sub_cost_3=self.data.sub_cost_3,
                    sub_cost_4=self.data.sub_cost_4,
                    sub_cost_5=self.data.sub_cost_5,
                    sub_cost_6=self.data.sub_cost_6,
                    sub_cost_7=self.data.sub_cost_7,
                    sub_cost_8=self.data.sub_cost_8,
                    sub_cost_9=self.data.sub_cost_9,
                    sub_cost_10=self.data.sub_cost_10,
                    m_cost = self.data.m_cost,
